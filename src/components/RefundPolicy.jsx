    ...
    <div className="mission-section">
      <div className="mission-text">
        ...
        <article style={{ textAlign: "left" }}>
          ...
          <ul><li>Duplicate Payment – If you accidentally made
          a duplicate donation.</li>
          <li>Unauthorized Transaction – If your payment
          method was used without your consent.</li></ul>
          How to Request a Refund: <br/><br/>
          ...
          refund request. Refunds,if approved it will be processed and credited
