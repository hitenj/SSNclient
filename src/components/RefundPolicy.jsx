    ...
    <div className="mission-section">
      <div className="mission-text">
        ...
        <article>
          ...
          <ol type="i">
            <li>
              Cancellations will only be considered if the request is made 1
            ...
            <li>
              SarvarthaSiddhi Foundation does not accept cancellation requests
              for perishable items like flowers, eatables, etc. However, the
            ...
            <li>
              ...
              1 days of receipt of products. In case you feel that the product
              received is not as shown on the site or as per your expectations,
              you must bring it to the notice of our customer service within 1
            ...
            <li>
              In case of any refunds approved by SarvarthaSiddhi Foundation, it
              will take 1 days for the refund to be processed to you.
            </li>
          </ol>
        </article>
      </div>
