  ...
  return (
    <div className="mission-section">
      <div className="mission-text">
        ...
        <ul>
          <li>
            <b>Introduction-</b> This Privacy Policy describes how SarvarthaSiddhi
            Foundation and its affiliates (collectively "SarvarthaSiddhi
            Foundation, we, our, us") collect, use, share, protect or otherwise
            process your information/ personal data through our website
            https://www.sarvarthasiddhi.org/ (hereinafter referred to as
          ...
          <li>
            <b>Collection-</b> We collect your personal data when you use our Platform,
            ...
            SarvarthaSiddhi Foundation seeking any personal data like
          ...
          <li>
            <b>Usage-</b> We use personal data to provide the services you request. To
          ...
          <li>
            <b>Sharing-</b> We may share your personal data internally within our group
          ...
          <li>
            <b>Data Deletion and Retention-</b> You have an option to delete your
            ...
            account. You may also write to us at the contact information
          ...
          <li>
            <b>Your Rights-</b> You may access, rectify, and update your personal data
            directly through the functionalities provided on the Platform.
          </li>
          <li>
            <b>Consent-</b> By visiting our Platform or by providing your information,
          ...
          <li>
            <b>Changes to this Privacy Policy-</b> Please check our Privacy Policy
