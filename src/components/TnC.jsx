  ...
  return (
    <div className="mission-section">
      <div className="mission-text">
        ...
        <article>
          <ol type="A"><li>This document is an electronic record in terms of Information
          ...
          https://www.sarvarthasiddhi.org/ ('Website'), including the related
          mobile site and mobile application (hereinafter referred to as
          'Platform').
            </li>
            <li>
          The Platform is owned by SarvarthaSiddhi Foundation, a company
          incorporated under the Companies Act, 1956 with its registered office
          at 39-22A-1, OLD IDGAH COLONY, OPP SATSANG PARK, Agra, India
